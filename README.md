...
* [desktop](#desktop)
    ...
    * [.ajaxIncludeParams](#desktop.ajaxIncludeParams) : <code>function</code>
    * [.ajaxOnErrorCode](#desktop.ajaxOnErrorCode) : <code>function</code>
    * [.ajaxOnError](#desktop.ajaxOnError) : <code>function</code>
    * [.ajaxGet(o)](#desktop.ajaxGet) ⇒ <code>Object</code>

<a name="new_desktop_new"></a>
### new desktop()
Triobo. This is a singleton (a single "instance" of a "class").

<a name="desktop.ajaxIncludeParams"></a>
### desktop.ajaxIncludeParams : <code>function</code>
Generates permanent AJAX queries parameters (e.g. tokens, anti-cache)

**Kind**: static property of <code>[desktop](#desktop)</code>  
**Default**: <code>null</code>  
<a name="desktop.ajaxOnErrorCode"></a>
### desktop.ajaxOnErrorCode : <code>function</code>
Handles error generated by server (receives error code returned by server).

**Kind**: static property of <code>[desktop](#desktop)</code>  
**Default**: <code>null</code>  
<a name="desktop.ajaxOnError"></a>
### desktop.ajaxOnError : <code>function</code>
...
<a name="desktop.ajaxGet"></a>
### desktop.ajaxGet(o) ⇒ <code>Object</code>
...
- desktop.ajaxIncludeParams
- desktop.ajaxOnErrorCode
- desktop.ajaxOnError
...
| [o.autohide] | <code>number</code> | <code>0</code> | whether to show overlay after finishing (2 = yes) |
