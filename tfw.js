...
var desktop={
   ...
   * @param {number} [o.autohide=0] - whether to show overlay after finishing (2 = yes)
   * @return {Object} - Returns XMLHttpRequest object
   * @see desktop.ajaxIncludeParams
   * @see desktop.ajaxOnErrorCode
   * @see desktop.ajaxOnError
   */
  ajaxGet:function(o) {
...
var tfw={
  ...
  dynamicTable:function(param){
	  return {
		 ...
		 * @default null
		 * @public
		 * @todo Generate automatically or ...
